...
//pour l'édition du menu
	...
	$('.navItems').click(()=>{
		...
		//voici le code que j'ai ajoutée
		console.log('tu a cilid');
	})
	...
	// });
	// $('#mobileNav').css('transform','red !important');
	// var atie = $("#" + origin.attr('data-activates'));
	// console.log(atie);
	// var test;
	// if( test =$('body').css('overflow')){
	// 	// /console.log('tout est bon',test);
	// }else{
	// 	console.log('absent');
	// }
	// $('#mobileNav').css('color','red');
