var ThemeManagment = {
	...
	useCustomColorBtn: `<a class=" btn-floating btn-large waves-effect waves-light hover-frama-orange frama-purple tooltipped pulse fixed" data-position="left"
			data-delay="350" data-tooltip="Utiliser un thème personnalisé" id="useCustomColorBtn" style="top: 110px ; right: 25px"><i class="material-icons">palette</i></a>`,
	useThemeSelectorBtn: `<a class=" btn-floating btn-large waves-effect waves-light hover-frama-orange frama-purple tooltipped fixed" data-position="left"
			data-delay="350" data-tooltip="Retour à la sélection de thème" id="useThemeSelectorBtn" style="top: 110px ; right: 25px"><i class="material-icons">view_module</i></a>`,
									...
									<div class="row">
										<form id="customColorThemeForm" class="col s12" style="padding: 10px 0 0 0 !important;" >
										  ...
										  <div class="row">
											  ...
											  <i class="grey-text" style="font-size: small">couleur de texte principale</i>
										  </div>
										  <div class="row">
											  <input name="second_color" type="color" value="` + t.second_color + `" class="validate">
											  <i class="grey-text" style="font-size: small">couleur de texte secondaire</i>
										  </div>
										  <div class="row">
											  <input name="contrasted_color" type="color" value="` + t.contrasted_color + `" class="validate">
											  <i class="grey-text" style="font-size: small">couleur de texte sur les image</i>
										  </div>
										  <div class="row ">
